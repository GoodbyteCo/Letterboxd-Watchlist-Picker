<template>
  <div>
    <div id="logo">
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="25" height="103" viewBox="0 0 100 414.22">
      <g>
...
#logo svg {
  ...
  animation: finish 0.8s cubic-bezier(0,.7,.39,1.35);
}
